        ...
        <div class="col-md-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <span class="card-title">{{ __('Update') }} Chauffeur</span>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('chauffeurs.update', $chauffeur->id) }}" role="form" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                        @csrf

                        @include('admin.chauffeur.form')
